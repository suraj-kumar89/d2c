...
export default function DecisionSection() {
    return (
        <section className="w-full flex justify-center bg-black overflow-hidden">
            <div
                className="
        w-full max-w-[90rem]
        ...
        "
                ...
                <div className="relative w-full flex flex-col items-center mt-6 sm:mt-8">
                    ...
                    <div className="hidden lg:block absolute top-[2.5rem] left-1/2 -translate-x-1/2 w-[60rem] h-[10.875rem] z-[1]">
                        ...
                        {/* LEFT LONG */}
                        <div className="absolute left-[4rem] top-0 w-[25.8125rem] h-[10.875rem]">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="flex items-start gap-3">
                            ...
                            <p className="text-[#A79D9A] text-sm sm:text-[0.95rem] leading-relaxed">
                                {text}
                            </p>
